...
head.js('app/config.js', function(){
	...
	for(var i in appConfig.themes){
		...
		head.js('app/themes/' + themename + '/' + themename + '.config.js', function(){
	...
	for(var i in appConfig.plugins){
		...
		head.js('app/plugins/' + ext + '/' + ext + '.config.js', function(){
...
head.ready('libs', function(){
	...
	head.js(
		...
		{hammer : "system/vendor/EightMedia/hammer-1.0.5.min.js"},
		{underscore : "system/vendor/underscore/underscore.js" },
		{angular : "system/vendor/angular/angular.js" },
		{angularModule : "system/vendor/angular/angular-resource.js" },
		{angularModule : "system/vendor/angular/angular-sanitize.js" },
		{angularModule : "system/vendor/angular/angular-cookies.js" },
		{angularModule : "system/vendor/angular-mobile-nav/mobile-nav.js" },
		{angularModule : "system/vendor/angular-retina/angular-retina.js" },
		{angularModule : "system/vendor/wzr1337/gestures-0.1.0.min.js" },
		{angularModule : "system/vendor/wzr1337/scrollable-4.2.5.min.js" },
		function(){
